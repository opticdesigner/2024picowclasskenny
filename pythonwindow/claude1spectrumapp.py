...
class SpectrumAnalyzer:
    ...
    def create_plots(self):
        try:
            ...
            sum_ax.set_title("總和光譜圖")
            sum_ax.set_xlabel("波長 (nm)")
            sum_ax.set_ylabel("強度 (mw)")
            ...
            norm_ax.set_title("正規化光譜圖")
            norm_ax.set_xlabel("波長 (nm)")
            norm_ax.set_ylabel("相對強度")
